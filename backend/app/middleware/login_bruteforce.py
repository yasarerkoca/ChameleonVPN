...
class LoginBruteForceMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        # DB fonksiyonları yoksa atla (uygulamayı bloke etme)
        ...
        try:
            ...
            # Kısa pencere için başarısız deneme sayısı
            ...
            # Body'yi oku (altta endpoint tekrar kullanabilsin)
            ...
            # Middleware hatasında akışı kesme
            return await call_next(request)
        finally:
            if db:
                try:
