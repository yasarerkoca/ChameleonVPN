...
Revision ID: beb3b7fa379b
Revises: 
Create Date: 2025-08-21 23:06:53.421040
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_anomaly_fraud_records_user_id'), 'anomaly_fraud_records', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_anomaly_fraud_records_user_id'), table_name='anomaly_fraud_records')
